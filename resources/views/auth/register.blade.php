            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="capital" class="col-md-4 col-form-label text-md-end">Capital</label>
                        ...
                        <div class="row mb-3">
                            <label for="fecha_nac" class="col-md-4 col-form-label text-md-end">Fecha de nacimiento</label>
                        ...
                        <div class="row mb-3">
                            <label for="fecha_reg" class="col-md-4 col-form-label text-md-end">Fecha de registro</label>

                            <div class="col-md-6">
                                @php($fecha = Carbon\Carbon::now()->format('Y-m-d'))
                                <input id="fecha_reg" type="date" class="form-control @error('fecha_reg') is-invalid @enderror" name="fecha_reg" value="{{$fecha}}" readonly required>
