...
@section("content")
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <h1 class="display-4 mb-5" style="font-size: 3.5rem;">Compras</h1>
                @if($errors->any())
                ...
                <form action="{{ route('compras.store') }}" method="POST">
                    ...
                    <div class="form-group mt-4">
                        <label for="cantidad_de_compra" class="custom-label">Cantidad de Criptomonedas a Comprar</label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="bi bi-currency-dollar fs-1"></i></span>
                            </div>
                        <input type="number" class="form-control form-control-lg text-center" id="cantidad_de_compra" name="cantidad_de_compra">
                    </div>
                    </div>
                    <div class="form-group mt-4">
                        <label for="total" class="custom-label">Total en Pesos</label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="bi bi-currency-dollar fs-1"></i></span>
                            </div>
